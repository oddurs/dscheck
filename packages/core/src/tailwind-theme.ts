// Generated from tailwindcss@4.3.3 theme.css — do not edit by hand.
...
export const tailwindDefaultTheme: Record<string, string> = {
  '--font-sans':
  ...
  '--default-mono-font-variation-settings':
    '--theme(--font-mono--font-variation-settings, initial)',
  '--blur': '8px',
